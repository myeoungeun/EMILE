...
## **✍️** [기획서 링크](https://www.notion.so/E-M-I-L-E-25ad0881b9c4806cb7d7edf8a5762e60)
...
<ul>
  <li>캐릭터 움직임/점프/벽잡기 개발</li>
  <li>맵 구현</li>
  <li>몬스터 패턴 제작 및 구현</li>
  <li>총알 발사 및 교체 구현</li>
</ul>
...
- 사실 수집 : 충돌은 실행되지만 `IDamageable` 객체가 `Null`로 확인됨, 터렛과는 정상적으로 상호작용이 작동함
